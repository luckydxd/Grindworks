...
Container(height: 60 , child: Padding(
  ...
  child:
      TextWidget(text: "Pencarian", fontSize:36),
  )
),
Container(
  ...
  children: [
    ...
    Row(
      children: [
        TextWidget(text:"Lihat Semua", fontSize: 14,
        color:Color(0xFFF76C5E)),
        IconButton(
          icon: Icon(Icons.arrow_forward_ios, color:Color(0xFFF76C5E),size:16),
          onPressed: (){
    ...
    itemBuilder: (_, i){
      return GestureDetector(
        onTap:(){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context)=>DetailBookPage(index: 1),
            ));
        },
            ...
            child:Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  fit:BoxFit.fill,
                  image: NetworkImage("http://192.168.109.73:8000/uploads/"+(articles[i].img?? '')),
              ),
            )
          )
        )
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              text: articles[i].author==null?"Lucky":articles[i].author??'',
              fontSize: 16,
              ),
...
Container(
    ...
    child: Row(
      ...
      children: [
        ...
        Row(
          children: [
            TextWidget(text: "Lihat Semua", fontSize: 14,color: Color(0xFFF76C5E)),
          IconButton(
            icon: Icon(Icons.arrow_forward_ios, color: Color(0xFFF76C5E), size: 16,),
            onPressed: (){
    ...
    child: Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (_, i){
              ...
              child: allarticles.length==0?CircularProgressIndicator(): 
              Container(
                height: height*0.4,
                width: 150,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    child: Image.network(
                      "http://192.168.109.73:8000/uploads/"+allarticles[i].img.toString(),
                      fit:BoxFit.contain,
                    ),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10),
                    ...
                    TextWidget(text: allarticles[i].author==null?"Lucky D.":""+(allarticles[i].author??''),
                    fontSize: 16,color: Color(0xFFa9b3bd))
                  ],
                ),
              )
              );
